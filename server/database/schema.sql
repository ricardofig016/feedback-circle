...
--@block
-- insert dummy data
INSERT INTO users (name, email, encrypted_password, appraiser_id, appraiser_notes, team_manager_id, team_manager_notes)
VALUES  ("Ricardo Castro", "ricardocastro@criticalmanufacturing.com", "-", null, "", null, ""),
        ("Bernardete Carecho", "BernardeteCarecho@criticalmanufacturing.com", "-", null, "", null, ""),
        ("Sónia Araújo", "soniaaraujo@criticalmanufacturing.com", "-", null, "", 2, "TM notes about sonia"),
        ("Duarte Pereira", "duartepereira@criticalmanufacturing.com", "-", 3, "appraiser notes about duarte", 2, "TM notes about duarte"),
        ("Vasco Cruz", "vascocruz@criticalmanufacturing.com", "-", 3, "appraiser notes about vasco", 2, "TM notes about vasco");
--
INSERT INTO feedbacks (sender_id, receiver_id, title, positive_message, positive_message_appraiser_edit, negative_message, negative_message_appraiser_edit, submission_date, competency, privacy, rating, appraiser_notes, team_manager_notes, type, context, actions, responsible_id, status, deadline)
VALUES  (1, 4, "Feedback 1", "This is the positive_message for feedback 1", "This is the positive_message for feedback 1", "This is the negative_message for feedback 1", "This is the negative_message for feedback 1", "2003-01-01 00:58:00", "general", "public", 1, "Appraiser notes for feedback 1", "", "performance", "council", null, null, null, null),
        (2, 4, "Feedback 2", "This is the positive_message for feedback 2", "This is the positive_message for feedback 2", "This is the negative_message for feedback 2", "This is the negative_message for feedback 2", "2006-03-10 05:50:03", "execution-and-delivery", "private", 2, "Appraiser notes for feedback 2", "TM notes for feedback 2", "continuous", "1:1", "actions for feedback 2", 2, "active", "2024-12-31 23:59:59"),
        ...
        (2, 4, "Feedback 4", "This is the positive_message for feedback 4", "This is the positive_message for feedback 4", "This is the negative_message for feedback 4", "This is the negative_message for feedback 4", "2017-12-25 23:42:04", "agility", "anonymous", 4, "Appraiser notes for feedback 4", "TM notes for feedback 4", "continuous", "TL/PM feedback", "actions for feedback 4", 2, "closed", "2025-12-31 23:59:59");
--
